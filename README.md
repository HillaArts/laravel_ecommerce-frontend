...
cart.js: Page displaying the current user's cart and the option to add/remove items.
orders.js: Page displaying the orders placed by the user.
index.js: Home page, where users can view products and access the cart.
services/
...
styles/
Contains global and page-specific styles, including the use of Tailwind CSS to create a modern and responsive UI.
...
Features
Cart Management: Users can add items to their cart, view the cart, and remove items.
Order Placement: Users can place orders directly from their cart.
Order History: Users can view the orders they have placed.
Dynamic UI: The frontend is dynamic and responsive, providing a smooth user experience across devices.
Technologies Used
...
JavaScript (ES6+): Used throughout the application to write modern, clean code.
Contribution
